...
describe("MAT semantic text-style policy", () => {
  it.each([
    ...
    ["MAT mobile/Button Mobile", "regular"],
    ["MAT desktop/Button desktop", "regular"],
    ["MAT compact/Button Compact", "regular"],
    ["MAT compact/H1 Compact", "bold"],
    ["MAT compact/H2 Compact", "medium"],
    ["MAT compact/H3 Compact", "medium"],
    ["MAT compact/Body Compact", "regular"],
    ["MAT compact/Body S Compact", "regular"],
    ["MAT compact/Label Compact", "medium"],
  ...
  it.each([
    ...
    "MAT compact/H1 desktop",
    "MAT desktop/H2 compact",
    "MAT compact/Label mobile",
    "Label",
