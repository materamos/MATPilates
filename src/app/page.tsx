    ...
    <>
      ...
      <main>
        <section className="landing-hero bg-[var(--mat-surface-default)] xl:h-[698px]">
          <div className="landing-hero__inner mx-auto max-w-[1232px] px-6 pt-8 pb-12 xl:grid xl:h-full xl:grid-cols-[720px_500px] xl:gap-3 xl:px-0 xl:pt-[79px] xl:pb-[53px]">
        ...
        <section id="metodo" className="landing-section landing-section--method bg-[var(--mat-surface-default)] px-6 py-16 xl:h-[810px] xl:px-0 xl:py-0">
        ...
        <section id="clases" className="landing-section landing-section--classes bg-[var(--mat-surface-brand)] px-6 py-16 xl:h-[810px] xl:px-0 xl:py-0">
        ...
        <section id="estudio" className="landing-section landing-section--studio bg-[var(--mat-surface-brand)] px-6 py-16 xl:h-[810px] xl:px-0 xl:py-0">
        ...
        <section id="contacto" className="landing-section landing-section--contact relative overflow-hidden bg-[var(--mat-surface-inverse)] px-6 py-16 text-[var(--mat-text-inverse)] xl:h-[810px] xl:px-0 xl:py-0">
